...
class CalibrationPanel(QWidget):
    ...
    def _apply_calibration(self):
        ...
        PeakFitter.USE_CALIBRATED_SHAPES = True  # Lock core widths to FWHM(E)
        ...
        QMessageBox.information(
            self,
            "Applied",
            "Calibration applied! Peak core widths are locked to FWHM(E) "
            "for all shapes.\nTail-Gaussian and Hypermet tail parameters "
            "stay free."
        )
