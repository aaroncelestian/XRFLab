...
def _batch_config_dict(config) -> dict:
    ...
    return {
        ...
        "peak_shape": str(getattr(config, "peak_shape", "tail_gaussian")),
        "grouped_lines": bool(getattr(config, "grouped_lines", True)),
...
def _batch_config_from_dict(data: dict):
    ...
    return BatchProcessingConfig(
        ...
        peak_shape=str(data.get("peak_shape", "tail_gaussian")),
        grouped_lines=bool(data.get("grouped_lines", True)),
